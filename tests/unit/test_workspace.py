...
from codex_workspace.domain import workspace as m, domain as d
...
class WorkspaceTests(unittest.TestCase):
    ...
    def test_all_projects_for_owner_but_only_granted_projects_for_member(self):
        catalog={**self.catalog,'projects':[{'id':self.project,'title':'Project'},{'id':'project-second','title':'Second'},{'id':'project-empty','title':'Empty'}],
