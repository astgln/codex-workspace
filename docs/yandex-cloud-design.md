...
Документ описывает целевую архитектуру, включая будущую поддержку вложений.
Текстовый MVP реализован; его точные границы и команды находятся в
[deployment.md](deployment.md). Документы сервисов проверены 2026-09-20.
