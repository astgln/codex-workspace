...
import hashlib
import time
from codex_workspace.crypto.workspace_crypto import CryptoError, Context, decode, encode, public_bytes, open_envelope
...
class PairingChannel:
    ...
    def poll(self, invitation_id: str, scopes: set[str]):
        ...
        from codex_workspace.devices.device_keys import delivery_scope, DeviceKeys
        from codex_workspace.agent.sealed_channel import SealedChannel
        from codex_workspace.crypto.workspace_crypto import signer_id
